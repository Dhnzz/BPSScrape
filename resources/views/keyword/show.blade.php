...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div>
                <a href="{{ route('target.edit', $target->id) }}" class="btn btn-warning text-white">Edit Target</a>
                <a href="{{ route('target.destroy', $target->id) }}" class="btn btn-danger text-white">Hapus
                    Target</a>
            </div>
